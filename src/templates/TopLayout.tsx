...
const TopLayout: FunctionComponent<NonArticlePageProps> = (props) => {
  const atomFeedPage = props.nonArticles.find(
    (nonArticle) => nonArticle.id === "atom-feed",
  ) as any;
  ...
  return (
    <div className="ubw-page ubw-non-article ubw-top">
            ...
            .map((article) => {
              return (
                <li key={article.articleId} className="ubw-articles-item">
                  <a
                    className="ubw-articles-item-link"
                    href={article.rootRelativePath}
                  >
                    {article.pageTitle}
                  </a>
      ...
      <ul className="ubw-meta-data">
        <li>
          <a href={atomFeedPage.rootRelativePath}>Atom Feed</a>
        </li>
        {props.additionalTopPageLinks.map((data, index) => {
          return (
            <li key={"ubw-meta-data-additional-link-" + index}>
